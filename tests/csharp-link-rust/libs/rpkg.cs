...
namespace csharp_link_rust.libs
{
    public class rpkg
    {
        ...
        private static void PkgSeekDependencies()
        {
            ...
            IntPtr deps_ptr1 = pkg_seek_dependencies(root_path, path1);
            ...
            IntPtr deps_ptr2 = pkg_seek_dependencies(root_path, path2);
            ...
            IntPtr deps_ptr3 = pkg_seek_dependencies(root_path, path3);
            ...
            IntPtr deps_ptr4 = pkg_seek_dependencies(root_path, path4);
        ...
        private static void PkgMatchPattern()
        {
            ...
            Console.WriteLine("      res: ");
            foreach (string file in InnerPrintStrs(strs_ptr))
            {
                Console.WriteLine("        " + file);
            }
            Console.WriteLine("");
